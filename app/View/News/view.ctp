...
<h2><?php  echo __('News'); ?></h2>
    <dl>
        ...
        <dd>
            <?php echo h($news['News']['dateCreated']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Date Updated'); ?></dt>
        <dd>
            <?php echo h($news['News']['dateUpdated']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Photo Url'); ?></dt>
        <dd>
            <?php echo h($news['News']['photoURL']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('More Info Url'); ?></dt>
        <dd>
            <?php echo h($news['News']['moreInfoURL']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Video Url'); ?></dt>
        <dd>
            <?php echo h($news['News']['videoURL']); ?>
            &nbsp;
        </dd>
