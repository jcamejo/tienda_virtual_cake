<div class="news index">
    ...
    <tr>
            ...
            <th><?php echo $this->Paginator->sort('moreInfoURL'); ?></th>
    ...
    <tr>
        ...
        <td><?php echo h($news['News']['dateCreated']); ?>&nbsp;</td>
        <td><?php echo h($news['News']['dateUpdated']); ?>&nbsp;</td>
        <td><?php echo h($news['News']['photoURL']); ?>&nbsp;</td>
        <td><?php echo h($news['News']['moreInfoURL']); ?>&nbsp;</td>
        <td><?php echo h($news['News']['videoURL']); ?>&nbsp;</td>
