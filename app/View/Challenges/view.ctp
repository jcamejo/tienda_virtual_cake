...
<h2><?php  echo __('Challenge'); ?></h2>
    <dl>
        ...
        <dd>
            <?php echo h($challenge['Challenge']['dateCreated']); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo h($challenge['Challenge']['friendlyName']); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo h($challenge['Challenge']['dateExpired']); ?>
            &nbsp;
        </dd>
    </dl>
</div>
...
<div class="related">
    <h3><?php echo __('Related Challenge Params'); ?></h3>
    <?php if (!empty($challenge['ChallengeParam'])): ?>
    <table cellpadding = "0" cellspacing = "0">
    <tr>
        <th><?php echo __('Id'); ?></th>
        <th><?php echo __('Challenge Id'); ?></th>
        <th><?php echo __('Param Name'); ?></th>
        <th><?php echo __('Param Value'); ?></th>
        <th class="actions"><?php echo __('Actions'); ?></th>
    </tr>
    <?php
        $i = 0;
        foreach ($challenge['ChallengeParam'] as $challengeParam): ?>
        <tr>
            <td><?php echo $challengeParam['id']; ?></td>
            <td><?php echo $challengeParam['challenge_id']; ?></td>
            <td><?php echo $challengeParam['paramName']; ?></td>
            <td><?php echo $challengeParam['paramValue']; ?></td>
            <td class="actions">
                <?php echo $this->Html->link(__('View'), array('controller' => 'challenge_params', 'action' => 'view', $challengeParam['id'])); ?>
                <?php echo $this->Html->link(__('Edit'), array('controller' => 'challenge_params', 'action' => 'edit', $challengeParam['id'])); ?>
                <?php echo $this->Form->postLink(__('Delete'), array('controller' => 'challenge_params', 'action' => 'delete', $challengeParam['id']), null, __('Are you sure you want to delete # %s?', $challengeParam['id'])); ?>
            </td>
        </tr>
    <?php endforeach; ?>
    </table>
