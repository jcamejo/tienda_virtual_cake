<div class="challenges index">
    ...
    <tr>
            ...
            <th><?php echo $this->Paginator->sort('friendlyName'); ?></th>
            <th><?php echo $this->Paginator->sort('reward'); ?></th>
            <th><?php echo $this->Paginator->sort('status'); ?></th>
            <th><?php echo $this->Paginator->sort('dateExpired'); ?></th>
            <th class="actions"><?php echo __('Actions'); ?></th>
    </tr>
    <?php foreach ($challenges as $challenge): ?>
    <tr>
        <td><?php echo h($challenge['Challenge']['id']); ?>&nbsp;</td>
        <td><?php echo h($challenge['Challenge']['dateCreated']); ?>&nbsp;</td>
        <td>
        ...
        <td><?php echo h($challenge['Challenge']['friendlyName']); ?>&nbsp;</td>
        <td><?php echo h($challenge['Challenge']['reward']); ?>&nbsp;</td>
        <td><?php echo h($challenge['Challenge']['status']); ?>&nbsp;</td>
        <td><?php echo h($challenge['Challenge']['dateExpired']); ?>&nbsp;</td>
        <td class="actions">
