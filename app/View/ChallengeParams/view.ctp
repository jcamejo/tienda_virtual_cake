...
<h2><?php  echo __('Challenge Param'); ?></h2>
    <dl>
        ...
        <dt><?php echo __('ParamName'); ?></dt>
        <dd>
            <?php echo h($challengeParam['ChallengeParam']['paramName']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('ParamValue'); ?></dt>
        <dd>
            <?php echo h($challengeParam['ChallengeParam']['paramValue']); ?>
            &nbsp;
        </dd>
    </dl>
</div>
