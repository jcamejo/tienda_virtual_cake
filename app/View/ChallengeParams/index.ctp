<div class="challengeParams index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $challengeParam['ChallengeParam']['id']), null, __('Are you sure you want to delete # %s?', $challengeParam['ChallengeParam']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
