<div class="platforms index">
    ...
    <tr>
        ...
        <td class="actions">
            ...
            <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $platform['Platform']['id']), null, __('Are you sure you want to delete # %s?', $platform['Platform']['id'])); ?>
        </td>
    </tr>
<?php endforeach; ?>
    </table>
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Nueva Plataforma'), array('action' => 'add')); ?></li>
    </ul>
</div>
