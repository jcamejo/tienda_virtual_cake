<div class="userArticles index">
    ...
    <tr>
            ...
            <th><?php echo $this->Paginator->sort('requestCode'); ?></th>
            <th><?php echo $this->Paginator->sort('status'); ?></th>
            <th><?php echo $this->Paginator->sort('deliveryDate'); ?></th>
    ...
    <tr>
        ...
        <td><?php echo h($userArticle['UserArticle']['purchaseDate']); ?>&nbsp;</td>
        <td><?php echo h($userArticle['UserArticle']['requestCode']); ?>&nbsp;</td>
        <td><?php echo h($userArticle['UserArticle']['status']); ?>&nbsp;</td>
        <td><?php echo h($userArticle['UserArticle']['deliveryDate']); ?>&nbsp;</td>
        <td class="actions">
