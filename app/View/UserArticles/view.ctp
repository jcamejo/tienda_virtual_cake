...
<h2><?php  echo __('User Article'); ?></h2>
    <dl>
        ...
        <dd>
            <?php echo $this->Html->link($userArticle['User']['firstName'], array('controller' => 'users', 'action' => 'view', $userArticle['User']['id'])); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo h($userArticle['UserArticle']['purchaseDate']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Request Code'); ?></dt>
        <dd>
            <?php echo h($userArticle['UserArticle']['requestCode']); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo h($userArticle['UserArticle']['deliveryDate']); ?>
            &nbsp;
        </dd>
    </dl>
</div>
